...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void deletePet() {
        if (mCurrentPetUri != null) {
            ...
            if (rowsDeleted == 0) {
                Toast.makeText(this, getString(R.string.editor_del_pet_failed), Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, getString(R.string.editor_del_pet_successfully), Toast.LENGTH_SHORT).show();
            }
        }
        finish();
    }
